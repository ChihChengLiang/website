...
- 適應刺激（Adaption）：頻率編碼有個小問題（稱為擠壓問題 squishing）。同樣是盯著一張白紙看，在日光之下和月光之下看，眼睛從白紙接受的光照量可能差百萬倍。假設神經訊號的輸出有個頻率上限，那勢必要把輸入的百萬倍差距，平均配到最大和最小輸出的範圍。如果白紙上有寫字，那這樣眼睛應該在陰暗之下會超不敏感。可是我們怎麼日光之下和月光之下都能分辨出字來？（書裡是沒提到和考慮瞳孔這類的機制）
神經元會依照刺激的重複程度，調節輸出的範圍。Edgar 做了個實驗，在蛙腿肌肉上吊個砝碼，並觀察神經元輸出訊號。第一次吊上去時，神經元輸出頻繁的訊號。但吊第二次、第三次時，訊號就變得稀疏。神經元的輸出訊號比較是衡量刺激的變動，而並非刺激本身。他會去抓到刺激的新的基準點在哪。適應刺激這個特性，解決掉了訊號擠壓問題。一旦神經元適應了日光或月光的基準點，輸出信號就能調整成對字體的明暗敏感。
