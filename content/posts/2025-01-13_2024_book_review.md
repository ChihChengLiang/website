...
It's that time again. This post is so overdued. I reviewed the books I've read in 2024.

Some of them are a quick braindump from what I can remember now. Others are from my quick notes after reading the book, and then GPT translated to English. I've sugar coated the post with GPT editing for flow, hope that makes the post more digestable. My thoughts is still messy, GPT can't save that. The more I wrote the less I care about perfection. Treat this post as a noisy GPT output, and a prompt input for your inspiration. Althpouh I've done my best effort, I might make lots of factual mistakes. Feedbacks and discussions in DM are welcomed. I'll do my best effort to reply but not guarranteed.
