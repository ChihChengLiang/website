...
Before writing this post, I read *Poor Economics* and *Power and Progress*. I now feel like I've heard 11 opinions from 10 economists, and some more from historians and anthropologists. I learned lots of messy things along the way, not neccessarily from the books above.

- Growth is the center of economics, everything else serves for it. As the recently deceased Nobel Prize economist Robert Lucas put it: “Once you start thinking about economic growth, it's hard to think about anything else.”
  - When solving the problem of proverty, economists ask if the poors have some justifiable fixed point in the growth function, aka "poverty trap", that stops them from growing themselves.
  - When solving the technology progress, economists build a growth model to ask if certain way to invest in technology that can best facillitate long term economic growth.
- Some economists think the modeling is impossible
  - because the fat tail distribution and you'll never empirically get parameters estimated for your beautiful model.
  - because some philosophical problem for economics is unresolved yet. It is too early to build math models.
  - Some historian think modeling miss the nuances in history.
- Some economists think the modeling is possible 
  - if we carefully build right abstraction and the right amount of complexity.
...
- Many agree that we learned lots of fairy tales about money in school
  - There wasn't evidence of bartering economics in history. Debt and tokens exist since day 1.
...
"blockchain is a solution looking for a problem." I heard this phrase somewhere but I was surprised to see people published various articles under the same title since 2016. There are definitely some truth in it, if not all. We're very good at solving the problems within the blockchain, building decentralized exchanges, improving transaction privacy, and off loading computation verification with cryptographic tools. I see proficiancy in developers, computer science acedemics, and even game thoerists.

But for solving the real world problem. I don't feel most of the people get the competency for that. I think the main reasons is that the barriers of computer science and cryptopgrahy attracts people with more proficiencies in these domain. The discourse about real world in the blockchain sphere feels off and not authentic. We're still lack of engaging in conversations in humanity acedemics.
...
Wether learning about the shaming from the childhood, the 400 years of econ history, human chewing cooked food in million years ago, or even a little bit longer the plants began to migrate, all helps understand who I am, how I am shaped, and how different we could become.
